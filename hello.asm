  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  29:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  2c:	e8 72 02 00 00       	call   2a3 <exit>
        printf(1, "Hello, xv6 User!\n");
  31:	50                   	push   %eax
  32:	50                   	push   %eax
  33:	68 34 07 00 00       	push   $0x734
  38:	6a 01                	push   $0x1
  3a:	e8 c1 03 00 00       	call   400 <printf>
  3f:	83 c4 10             	add    $0x10,%esp
  42:	eb e8                	jmp    2c <main+0x2c>
  44:	66 90                	xchg   %ax,%ax
  46:	66 90                	xchg   %ax,%ax
  48:	66 90                	xchg   %ax,%ax
  4a:	66 90                	xchg   %ax,%ax
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 50 07 00 00 	jmp    *0x750(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 587:	90                   	nop
          s = "(null)";
 588:	ba 46 07 00 00       	mov    $0x746,%edx
        while(*s != 0){
 ...
 5a1:	a1 50 0a 00 00       	mov    0xa50,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 50 0a 00 00    	mov    %edx,0xa50
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 50 0a 00 00    	mov    %edx,0xa50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 50 0a 00 00    	mov    0xa50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 50 0a 00 00    	mov    0xa50,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 50 0a 00 00    	mov    0xa50,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 50 0a 00 00    	mov    %edx,0xa50
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 50 0a 00 00 54 	movl   $0xa54,0xa50
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	bf 54 0a 00 00       	mov    $0xa54,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 54 0a 00 00 54 	movl   $0xa54,0xa54
 706:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 712:	00 00 00 
    if(p->s.size >= nunits){
